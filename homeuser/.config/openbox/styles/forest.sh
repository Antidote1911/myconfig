...
sed -i -e 's/font-0 = .*/font-0 = "Source Code Pro:Regular:size=9;2"/g' $polybar_path/forest/config.ini
...
sed -i -e 's/font:.*/font:				 	"Noto Sans Regular 10";/g' "$rofi_path/forest/font.rasi"
...
sed -i -e 's/font:.*/font:				 	"Noto Sans Regular 10";/g' "$rofi_path/dialogs/askpass.rasi" "$rofi_path/dialogs/confirm.rasi"
...
sed -i -e 's/editor_font=.*/editor_font=Noto Sans Regular 10/g' "$geany_path"/geany.conf
...
sed -i -e 's/font = .*/font = Noto Sans Regular 10/g' $dunst_path/dunstrc
