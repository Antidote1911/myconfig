...
# wallpaper ---------------------------------
nitrogen --save --set-zoom-fill /usr/share/backgrounds/wall6.jpg

# polybar ---------------------------------
sed -i -e 's/STYLE=.*/STYLE="forest"/g' $polybar_path/launch.sh
sed -i -e 's/font-0 = .*/font-0 = "NotoSans-Regular:size=10;2"/g' $polybar_path/forest/config.ini
...
sed -i -e 's/font:.*/font:				 	"Noto Sans 11";/g' "$rofi_path/forest/font.rasi"
...
sed -i -e 's/font:.*/font:				 	"NotoSans-Regular 10";/g' "$rofi_path/dialogs/askpass.rasi" "$rofi_path/dialogs/confirm.rasi"
...
# termite ---------------------------------
sed -i -e 's/font = .*/font = Source Code Pro Regular 10/g' $termite_path/config
...
sed -i -e 's/font = .*/font = Source Code Pro Regular 10/g' $termite_path/config_easy
...
sed -i -e 's/editor_font=.*/editor_font=Noto Sans 11/g' "$geany_path"/geany.conf
...
sed -i -e 's/font = .*/font = Noto Sans 11/g' $dunst_path/dunstrc
